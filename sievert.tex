...
made starting in 2008 can be obtained from \code{db} with the following
query using \pkg{dplyr}.
%
\begin{Schunk}
\begin{Sinput}
pitch <- tbl(db, "pitch") %>%   
...
\CRANpkg{knitr} package \citet{knitr}. The source files can be found
